...
const getData = async (event) => {
  ...
  const fetchData = await fetch(
    `https://api.weatherapi.com/v1/forecast.json?key=2529a49f9d964bf7a78173605231502&q=${city}`
  );
  ...
  weatherStatus.innerHTML = data.current.condition.text;sunrise.innerHTML = data.forecast["forecastday"][0].astro.sunrise;
